...
class Topic(models.Model):
    ...
    board = models.ForeignKey(Board, related_name='topics', verbose_name='版块名称')
    starter = models.ForeignKey(User, related_name='topics', verbose_name='发布者')


class Post(models.Model):
    message = models.TextField(max_length=40000, verbose_name='内容')
    topic = models.ForeignKey(Topic, related_name='posts', verbose_name='发布主题')
    ...
    created_by = models.ForeignKey(User, related_name='posts', verbose_name='创建时间')
    updated_by = models.ForeignKey(User, null=True, related_name='+', verbose_name='更新时间')
